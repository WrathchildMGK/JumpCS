...
public class Clt_Un : IOpcodeTranslation
{
    public void Translate(object? operand, IBackendSupport support)
    {
        if (support.Stack.StackDepth >= 4 && support.Stack.IsTopDoubleWord)
        {
            ...
            support.AsmWriter.WriteLine($"    JSR __ltdf2           ; IEEE 754 double less-than (unsigned/unordered)");
