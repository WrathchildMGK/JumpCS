...
public class Cgt_Un : IOpcodeTranslation
{
    public void Translate(object? operand, IBackendSupport support)
    {
        if (support.Stack.StackDepth >= 4 && support.Stack.IsTopDoubleWord)
        {
            ...
            support.AsmWriter.WriteLine($"    JSR __gtdf2           ; IEEE 754 double greater-than (unsigned/unordered)");
        ...
        else
        {
            ...
            support.AsmWriter.WriteLine($"    BHI {label}_gt");
