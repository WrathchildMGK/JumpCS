...
namespace JumpCS.Backend.SystemTypes
{
    ...
    public class SystemDecimalHandler : SystemHandlerBase
    {
        ...
        private void HandleOpLessThan(Asm68000StackSimulator stack)
        {
        ...
        private void HandleOpGreaterThan(Asm68000StackSimulator stack)
        {
        ...
        private void HandleOpLessThanOrEqual(Asm68000StackSimulator stack)
        {
        ...
        private void HandleOpGreaterThanOrEqual(Asm68000StackSimulator stack)
        {
        ...
        private void HandleOpEquality(Asm68000StackSimulator stack)
        {
        ...
        private void HandleOpInequality(Asm68000StackSimulator stack)
        {
