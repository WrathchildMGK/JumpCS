...
{
    /// <summary>Handler for System.Single (float) type operations - CC65 (6502) target</summary>
    public class SystemFloatHandler : SystemHandlerBase, ISystemFloatHandler
    {
        ...
        public override void HandleReflectionMethodCall(MethodBase methodInfo, IBackendStackSimulator stack)
        {
            ...
            AsmWriter?.WriteLine($"    ; System.Single.{methodName}");
        ...
        public void HandleAddition(IBackendStackSimulator stack)
        {
            ...
            AsmWriter?.WriteLine($"    ; Single Addition (CC65 runtime)");
            AsmWriter?.WriteLine($"    JSR __addsf3     ; Delegate to CC65 runtime");
        }
        ...
        public void HandleSubtraction(IBackendStackSimulator stack)
        {
            string right = stack.Pop();
            string left = stack.Pop();
            AsmWriter?.WriteLine($"    ; Single Subtraction (CC65 runtime)");
            AsmWriter?.WriteLine($"    JSR __subsf3     ; Delegate to CC65 runtime");
        }
        ...
        public void HandleMultiply(IBackendStackSimulator stack)
        {
            string right = stack.Pop();
            string left = stack.Pop();
            AsmWriter?.WriteLine($"    ; Single Multiply (CC65 runtime)");
            AsmWriter?.WriteLine($"    JSR __mulsf3     ; Delegate to CC65 runtime");
        }
        ...
        public void HandleDivision(IBackendStackSimulator stack)
        {
            string right = stack.Pop();
            string left = stack.Pop();
            AsmWriter?.WriteLine($"    ; Single Division (CC65 runtime)");
            AsmWriter?.WriteLine($"    JSR __divsf3     ; Delegate to CC65 runtime");
        }

        public void HandleUnaryNegation(IBackendStackSimulator stack)
        {
            string operand = stack.Pop();
            AsmWriter?.WriteLine($"    JSR Single_Negate");
        }
        ...
        public void HandleEquality(IBackendStackSimulator stack)
        {
            string right = stack.Pop();
            string left = stack.Pop();
            AsmWriter?.WriteLine($"    JSR Single_Equals");
        }
        ...
        public void HandleInequality(IBackendStackSimulator stack)
        {
            string right = stack.Pop();
            string left = stack.Pop();
            AsmWriter?.WriteLine($"    JSR Single_NotEquals");
        }
        ...
        public void HandleLessThan(IBackendStackSimulator stack)
        {
            string right = stack.Pop();
            string left = stack.Pop();
            AsmWriter?.WriteLine($"    JSR Single_LessThan");
        }
        ...
        public void HandleGreaterThan(IBackendStackSimulator stack)
        {
            string right = stack.Pop();
            string left = stack.Pop();
            AsmWriter?.WriteLine($"    JSR Single_GreaterThan");
        }
        ...
        public void HandleLessThanOrEqual(IBackendStackSimulator stack)
        {
            string right = stack.Pop();
            string left = stack.Pop();
            AsmWriter?.WriteLine($"    JSR Single_LessThanOrEqual");
        }
