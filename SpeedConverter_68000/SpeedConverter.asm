...
SpeedConverter_Program_RunTest:
    ...
    JSR SpeedConverter_Tests_SpeedConversionServiceTests_ConvertToMilesPerHour_Input_Expected
    ...
    MOVE.L A0,D7
    ; ERROR: Exception processing ldstr at offset 0015
    ...
    ; ERROR: Exception processing ldarg.1 at offset 0021
    ; Evaluation stack overflow
    ; Offset 0022: call
    ...
    MOVE.L A0,D6
    ; ERROR: Exception processing ldstr at offset 0029
    ; Evaluation stack overflow
    ; Offset 002E: call
    ; Framework method: System.Runtime.CompilerServices.DefaultInterpolatedStringHandler::AppendLiteral
    ; TODO: Implement framework call
    ...
    MOVE.L A0,D7
    ; Offset 0035: ldarg.2
    MOVE.L 16(A6),D6  ; Load arg.2 (third param)
    ...
    MOVE.L A0,D7
    ; Offset 0051: call
    ; Framework method: System.Runtime.CompilerServices.DefaultInterpolatedStringHandler::ToStringAndClear
    ; TODO: Implement framework call
    ; ERROR: Exception processing call at offset 0051
    ; Evaluation stack overflow
    ; Offset 0056: call
    ; Framework method: System.Console::WriteLine
    ; TODO: Implement framework call
    ; Offset 005B: ret
    MOVE.L D5,D0  ; Move return value to D0
...
SpeedConverter_Program_Main:
    ...
    ; Offset 0000: newobj
    ; System.Decimal newobj - create new instance (0 parameters)
    ; TODO: Decimal newobj with 0 parameters (expected 5)
    ; Offset 0005: stloc.0
    MOVE.L D0,-4(A6)   ; Store to local 0
    ; Offset 0006: ldloc.0
    ...
    MOVE.L #6,D2         ; Load 6
    ; Offset 000A: call
    ; Call SpeedConverter.Program.RunTest(LSpeedConverter/Tests/SpeedConversionServiceTests;II)V
    JSR SpeedConverter_Program_RunTest
    ; Offset 000F: ldloc.0
    ...
    ; ERROR: Exception processing ldc.i4.s at offset 0019
    ; Evaluation stack overflow
    ; Offset 001B: ldc.i4.s
    MOVE.L #12,D7  ; Load short constant
    ; ERROR: Exception processing ldc.i4.s at offset 001B
    ; Evaluation stack overflow
    ; Offset 001D: call
    ; Call SpeedConverter.Program.RunTest(LSpeedConverter/Tests/SpeedConversionServiceTests;II)V
    JSR SpeedConverter_Program_RunTest
    ...
    ; Framework method: System.IDisposable::Dispose
    ; TODO: Implement framework call
L_002D:
...
SpeedConverter_Tests_SpeedConversionServiceTests_ConvertToMilesPerHour_Input_Expected:
    ...
    ; Call SpeedConverter.Code.SpeedConversionService.ConvertToMilesPerHour(I)I
    JSR SpeedConverter_Code_SpeedConversionService_ConvertToMilesPerHour
    ; Return value pushed (non-void method)
    ; Offset 000C: stloc.0
    MOVE.L D0,-4(A6)   ; Store to local 0
    ; Offset 000D: ldarg.2
...
SpeedConverter_Code_SpeedConversionService_ConvertToMilesPerHour:
    ...
    ; Offset 000C: call
    ; System.Math.Round (library call) - 1 parameters
    ; Round(double) - Library call
    MOVE.L D0,D0
    MOVE.L D1,D1
    JSR Math_RoundDouble_NoDigits
    ; Result in D0:D1
    ; Offset 0011: conv.i4
    MOVE.L D1,D1  ; Convert to I4
    ; Offset 0012: ret
    MOVE.L D1,D0  ; Move return value to D0
